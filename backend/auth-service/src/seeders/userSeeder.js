...
async function seedUsers() {
    try {
        const existingUsers = await db_1.pool.query("SELECT COUNT(*) FROM users");
        ...
        for (const user of testUsers) {
            ...
            await db_1.pool.query(`INSERT INTO users (username, password, first_name, last_name, email, phone) 
         VALUES ($1, $2, $3, $4, $5, $6)`, [user.username, hash, user.first_name, user.last_name, user.email, user.phone]);
        }
